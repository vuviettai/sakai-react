...
const AppMenu = () => {
    ...
    const model: AppMenuItem[] = [
        // {
        //     label: 'Identity',
        //     items: [{ label: 'Create identity', icon: 'pi pi-fw pi-id-card', to: '/identity/create' }]
        // },
        {
            label: 'Encryption',
            icon: 'pi pi-fw pi-lock',
            items: [
                {
                    label: 'Import privkey',
                    icon: 'pi pi-fw pi-key',
                    to: '/encryption/privkey/import'
                },
                // {
                //     label: 'Import pubkey',
                //     icon: 'pi pi-fw pi-key',
        ...
        },
        {
            label: 'Asset',
            items: [
                { label: 'Create asset', icon: 'pi pi-fw pi-file-edit', to: '/assets/create' },
                { label: 'Get all assets', icon: 'pi pi-fw pi-list', to: '/assets/list' }
            ]
        },
        {
            label: 'Files',
