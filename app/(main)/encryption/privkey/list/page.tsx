            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="organization" header="Organization" filter filterPlaceholder="Search by organization" style={{ minWidth: '12rem' }} />
                        <Column field="publicKey" header="Public Key" style={{ minWidth: '20rem' }} />
                    </DataTable>
                </div>
            </div>
        </div>
